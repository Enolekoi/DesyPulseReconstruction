...
WEIGHT_DECAY = 1e-1     # TODO find description
...
DESCRIPTOR = f"Training using weight decay 1e-1 insead of 1e-5, new dataset and no FROG-Error - with {NUM_EPOCHS} Epochs"
