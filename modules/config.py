...
LEARNING_RATE = 0.0005953    # Learning rate at the beginning of training
MAX_LEARNING_RATE = 0.005953
...
DESCRIPTOR = f"Training supervised with variing hyperparameters, new dataset and no FROG-Error - with {NUM_EPOCHS} Epochs"
