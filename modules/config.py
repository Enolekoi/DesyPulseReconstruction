...
DESCRIPTOR = f"Training using 1cycle, new dataset and no FROG-Error - with {NUM_EPOCHS} Epochs"
...
RandomPredictionFilePath    = f"{LogSubdiretory}/random_prediction.png"
