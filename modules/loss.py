...
def hilbert(signal, plot=False):
    ...
    if plot:
        ...
        plt.subplot(4,1,1)
        plt.plot(signal, label='Realteil')
        plt.title('Realteil des Zeitsignals')
        ...
        plt.subplot(4,1,2)
        plt.plot(freq_axis, signal_fft, label='Realteil')
        plt.title('FFT des Realteils des Zeitsignals')
        plt.ylabel('Intensität')
        ...
        plt.subplot(4,1,3)
        plt.plot(H, label='Hilbert-Maske')
        plt.title('Maske der Hilbert-Transformation')
        ...
        plt.subplot(4,1,4)
        plt.plot(freq_axis, signal_fft_hilbert, label='Signal nach Hilbert-Maske')
        plt.title('Signal nach Multiplikation mit der Maske der Hilbert-Transformation')
        plt.ylabel('Intensität')
        plt.xlabel('Kreisfrequenz [1/s]')
        plt.legend()
        plt.grid()
