...
UNFREEZE_EPOCH = 18 # Epoch after which the whole model is trained (before that only the output layers are trained)
...
TBDRMS_THRESHOLD = 0.5  # Only data with a TBDrms higher than this threshold is used for training
...
TBDrmsFilename = "./TBDrms_list_grid_256_v3_sorted.csv" # Path to a sorted list of all directories and their corresponfing TBDrms
