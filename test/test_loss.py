...
Script used for testing loss function
'''
...
spec_reader = data.ReadSHGmatrix()
spec_wave_transform = data.ResampleSHGmatrix(
...
spec_freq_transform = data.ResampleSHGmatrix(    
    config.OUTPUT_NUM_DELAYS, 
    config.OUTPUT_TIMESTEP, 
    config.OUTPUT_NUM_FREQUENCIES,
    config.OUTPUT_START_FREQUENCY,
...
loss_fun = loss.PulseRetrievalLossFunction(
